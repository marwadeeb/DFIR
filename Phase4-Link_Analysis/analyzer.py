...
def build_contents(gml_text: str) -> list:
    ...
    main_prompt = (
        ...
        "   - purely logistical/utility contacts (e.g., numbers with only short calls),\n"
        "   - group nodes (e.g., Alpha Updates) and what their purpose likely is.\n"
        ...
        "(e.g., attempts to avoid logs, talk of sanitizing metadata, hiding information, avoiding company channels, "
        "or unusual timing/frequency of contact). Explain *why* they are suspicious.\n"
